...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* Background Glow - Matches the warm golden/amber radial glow behind the person */}
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 w-full flex-grow flex flex-col justify-center relative z-10">
        ...
        {/* Core Hero Grid mimicking the reference layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center lg:pt-8">
          
          {/* Left Side: Floating Badge on Desktop, embedded on Mobile */}
          <div className="lg:col-span-3 order-2 lg:order-1 flex flex-col gap-6 lg:items-start lg:text-left text-center">
            ...
            {/* Hidden on mobile, beautiful subtle scroll instruction on desktop */}
          ...
          {/* Center Column: Portrait Image + Large Italic Serif Greeting behind it */}
          <div className="lg:col-span-6 order-1 lg:order-2 flex flex-col items-center justify-center relative min-h-[400px] sm:min-h-[500px]">
            ...
            {/* "Hey, there" / "Salut, moi c'est" Serif Italic background text */}
            <motion.div
            ...
            >
              ...
              {/* Gradient fade overlay at the bottom matching reference */}
          ...
          {/* Right Side: Floating Paragraph of Skills/Specialization */}
        ...
        <div className="relative z-20 w-full mt-8 md:mt-12 select-none border-t border-brand-dark/5 pt-8">
          <div className="flex flex-col md:flex-row md:items-baseline md:justify-between gap-4">
            ...
            {/* Right side: DÉVELOPPEUR WEB & MOBILE */}
            <motion.div
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <a
            ...
            onClick={(e) => {
              e.preventDefault();
              alert(`Le téléchargement du CV de ${DEV_INFO.name} démarrera dans un instant (Maquette de démonstration).`);
            }}
